...
define('DESCRIPTION_SUSPENSION',' The job of a car suspension is to maximize the friction between the tires and the road surface, to provide steering stability with good handling and to ensure the comfort of the passengers.Suspension systems must support both road holding/handling and ride quality,[2] which are at odds with each other. The tuning of suspensions involves finding the right compromise. It is important for the suspension to keep the road wheel in contact with the road surface as much as possible, because all the road or ground forces acting on the vehicle do so through the contact patches of the tires. The suspension also protects the vehicle itself and any cargo or luggage from damage and wear.');
?>