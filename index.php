...
<body>
    ...
    <div class="jumbotron p-5 rounded-0">
        <div class="container p-5">
            ...
            <p class="lead">
    <a class="btn btn-primary btn-lg button-theme button" href="api-docs" role="button"><?php echo DOCUMENTATION; ?></a>
  </p>
        </div>
    </div>
    ...
    <h2 class="text-center"> <?php echo CONTACT; ?></h2>
      <div class="card-body">
        ...
        <a href="#" class="btn btn-primary" id="close-contact"><?php echo CLOSE?></a>
      </div>
    </div>
